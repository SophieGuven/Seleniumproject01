...
public static void tears(){
    System.out.println("tears come out");
}

    //write 2tests:
    // test 1: navigate to https://search.yahoo.com
...
@Test
    ...
    assertEquals(expectedTitle, actualTitle);//import static org.junit.jupiter.api.Assertions.*;
    ...
    public void testYahooSearchResultPageTitle(){
        ...
        //identify searchbox and enter selenium, and hit enter key on keyword
        WebElement searchBox= driver.findElement(By.xpath("//input[@name='p']"));
        searchBox.sendKeys("Selenium" + Keys.ENTER);//to hit enter
        driver.quit();
